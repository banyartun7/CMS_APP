        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="author.html">Admin login</a>
                    </li>
                </ul>
                <!-- End Menu -->
                <!-- Begin Search -->
...
================================================== -->
    <div class="container">
        <div class="mainheading">
            <h1 class="sitetitle">Web Technology</h1>
            <p class="lead">
        ...
        <section class="recent-posts">
            ...
            <div class="card-columns listrecent">
                ...
                @foreach ($posts as $post)
                    <div class="card">
                        <a href="post.html">
                            <img style="width:100%;height:30%" src="{{ url('/images/' . $post->featured) }}"
                                alt="">
                        </a>
                        <div class="card-block">
                            ...
                            <h4 class="card-text">{{ Str::limit($post->content, 100) }}</h4>

        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2 col-xs-12">
                <div class="mainheading">
                    ...
                    <h1 class="posttitle">{{ $shows->title }}</h1>

                </div>

                <!-- Begin Featured Image -->
                <img class="featured-image img-fluid" src="{{ url('/images/' . $shows->featured) }}" alt="">
                <!-- End Featured Image -->
                <div class="text-center mb-3">
                    <i>Category : </i><span class="badge badge-primary">{{ $shows->category->name }}</span>
                </div>
                <!-- Begin Post Content -->
                ...
                <div class="after-post-tags">
                    <ul class="tags">
                        @foreach ($shows->tags as $tag)
                            <li><a href="{{ route('post.tags', $tag->slug) }}">{{ $tag->name }}</a></li>
                        @endforeach
                    </ul>
                </div>
                <!-- End Tags -->
            ...
            <div class="row listrecent listrelated">
                ...
                @foreach ($randoms as $random)
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            <a href="post.html">
                                <img style="width:100%;height:30%" src="{{ url('/images/' . $random->featured) }}"
                                    alt="">
                            </a>
                            <div class="card-block">
                                <h2 class="card-title"><a
                                        href="{{ route('post.detail', $random->id) }}">{{ $random->title }}</a></h2>
                                <div class="metafooter">
                                    <div class="wrapfooter">
                                        ...
                                        <span class="author-meta">
                                            ...
                                            <span
                                                class="post-date">{{ $random->created_at->diffForHumans() }}</span><span
...
================================================== -->
    <div class="container margtop3rem">
        <h5 class="text-secondary">Tags List</h5>
        @foreach ($tags as $tag)
            <a href="{{ route('post.tags', $tag->slug) }}"
                class="badge badge-primary text-white m-1">{{ $tag->name }}</a>
        @endforeach
    </div>
...
================================================== -->
    <div class="alertbar">
        <div class="container text-center">
            <img src="assets/img/logo.png" alt=""> &nbsp; Never miss a <b>story</b> from us, get weekly
